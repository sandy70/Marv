...
public:
	...
	int AddEvidence(int handle, const std::vector<double> &soft);
	...
	int SetEvidence(int index, const std::vector<double> &soft);
	...
	int SetEvidenceByHandle(int handle, const std::vector<double> &soft) { return SetEvidence(HandleToIndex(handle), soft); }
	...
	int GetEvidence(int index, int &handle, std::vector<double> &soft) const;
	...
	int GetEvidenceByHandle(int handle, std::vector<double> &soft) const { int unused; return GetEvidence(HandleToIndex(handle), unused, soft); }
...
private:
	...
	enum { typeDiscrete, typeContinous, typeSoft, typeTemporal };
