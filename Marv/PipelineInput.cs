...
namespace Marv
{
    public class PipelineInput
    {
        ...
        public Dict<string, string, double> GetGraphEvidence(Graph graph, string pipeName, string locationName)
        {
            ...
            while (colName != null)
            {
                ...
                if (evidenceType != null)
                {
                    if (evidenceType == "Simple")
                    {
                        ...
                        //var evidence = EvidenceStringFactory.Create(evidenceString).ParseEvidence(vertex.States, evidenceString);
